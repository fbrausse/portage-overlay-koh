...
RDEPEND="
	>=dev-haskell/hgmp-0.1.1:=[profile?] <dev-haskell/hgmp-0.2:=
	>=dev-haskell/singletons-2.1:=[profile?] <dev-haskell/singletons-2.6:=
	>=dev-haskell/reflection-2.1.2:=[profile?] <dev-haskell/reflection-2.2:=
